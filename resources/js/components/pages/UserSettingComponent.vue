  ...
  <div class="wrap">
    <v-container class="main_profile text-center">
      ...
      <v-form ref="form" v-model="valid" lazy-validation>
        ...
        <v-btn @click="saveUserProfileData" outlined color="#bc8f8f" class="submit_btn">変更を保存</v-btn>
      </v-form>
    </v-container>
    <v-container class="sub_profile text-center">
      <v-col v-if="filledUserGender">
        ...
        <v-btn @click="saveUserTaste" outlined color="#bc8f8f" class="submit_btn">保存</v-btn>
      </v-col>
      <v-col v-else>
