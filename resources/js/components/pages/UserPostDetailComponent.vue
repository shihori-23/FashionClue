        ...
        <v-container class="mainWrap">
            ...
            <div class="mx-auto postCard card" max-width="344" outlined>
                <v-list-item>
                    ...
                    <v-list-item-content class="list_title_wrap">
                        ...
                        <v-list-item-subtitle class="caption">
                            ...
                            <span v-if="postUser.age"
                                >/ {{ postUser.age }}歳</span
                            >
                        </v-list-item-subtitle>
                        <span
                            v-if="postContent.category_name"
                            class="categoryChip"
                        >
                            <v-chip
                                ...
                                outlined
                                color="#a0a0a0"
                                >{{ postContent.category_name }}</v-chip
                            >
                        </span>
              ...
              <v-chip class="ma-1 category_chips" small outlined color="#a0a0a0">解決済みです</v-chip>
                ...
                <v-card-text class="px-4 pb-0 pt-2 textColor">
                    {{ postContent.text }}
                </v-card-text>
                <v-img
                    v-if="postContent.post_image"
                ...
                <v-card-actions class="iconWrap">
                    ...
                    <PostBookmarkComponent
                        v-else
                        @add-post-bookmark="addPostBookmark(postContent.id)"
                        :post_id="parseInt(postContent.id)"
                        :isBookmarked="false"
                    />
                    ...
                    <span class="caption captionColor answerCount">
                        {{ postedAnswers.length }}
                    </span>
                    <div class="flagIcon">
                        <v-btn
                            icon
                            v-if="
                                loginUser == postUser.id &&
                                    isVisible.editReviewBtn
                            "
                    ...
                    <div class="flagIcon">
                        <v-btn
                            icon
                            v-if="
                                loginUser == postUser.id && isVisible.reviewBtn
                            "
                    ...
                    <div class="flagIcon">
                        <v-btn
                            v-if="isVisible.reviewSubmitBtn"
                            text
                            @click="saveBestAnswerData()"
                            >決定</v-btn
                        >
                    </div>
                    <MomentJs
                        :time="postContent.created_at"
                        class="caption captionColor data"
                    />
                </v-card-actions>
            </div>
            ...
            <div v-if="isVisible.postedAnswer">
                ...
                >
                    ...
                    />
                    <label v-if="isVisible.reviewCheckbox"
                        >ベストアンサーに選ぶ</label
                    >
                    <v-list-item>
                    ...
                    <v-card-text class="px-4 pb-0 pt-2 textColor">
                        <p>{{ answer.text }}</p>
                        <div v-if="answer.url" class="mt-2 answerUrl">
                            <a text :href="answer.url">参考ページはこちら </a>
                        </div>
                    </v-card-text>
                    <v-img
                    ...
                    <v-card-actions class="iconWrap">
                        ...
                        <AnswerBookmarkComponent
                            v-else
                            @add-answer-bookmark="addAnswerBookmark(answer.id)"
                            :answer_id="parseInt(answer.id)"
                            :isBookmarked="false"
                        />
                        <MomentJs
            ...
            >
                <v-form ref="form" v-model="valid" lazy-validation>
                    ...
                    <input
                        ...
                        name="postId"
                        id="postId"
                        v-model="answerContent.postId"
                    />
                    <v-btn
                        @click="cancelOperationAtClick()"
                        class="cansel_btn"
                        text
                        >キャンセル</v-btn
                    >
                    <v-btn
                        @click="saveAnswerPostData"
                        color="#bc8f8f"
                        class="submit_btn"
                        text
                        >回答</v-btn
    ...
    methods: {
        ...
        getPostData: function() {
            axios
                ...
                .then(res => {
                    ...
                    this.postedAnswers.gender = parseInt(
                        postedAnswersData.gender
                    );
        ...
        setAnswerData: function() {
            ...
            Object.keys(this.answerContent).forEach(attributeName => {
                ...
                formData.append(
                    attributeName,
                    this.answerContent[attributeName]
                );
            });
