        ...
        <v-list-item-group>
          ...
          <v-list-item 
            ...
            <v-list-item-content v-if="notice.role == 0" :style="styleObject">
              <v-list-item-subtitle v-if="notice.answer_owner_id">{{ notice.answer_owner_name }}さんがあなたの質問に回答しました！　<MomentJs :time="notice.created_at"/></v-list-item-subtitle>
              <v-list-item-subtitle v-else-if="notice.review_owner_id">{{ notice.review_owner_name }}さんがあなたの回答に対して評価を付けました！　<MomentJs :time="notice.created_at"/></v-list-item-subtitle>
            </v-list-item-content> 
